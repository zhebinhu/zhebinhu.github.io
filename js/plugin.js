    ...
    return function t(r, s, e) {
        ...
        1: [function (t, r) {
            ...
            function i(t) {
                ...
                r /= 255, s /= 255, e /= 255;
                var i, n, o = Math.max(r, s, e), a = Math.min(r, s, e), h = (o + a) / 2;
                if (o === a) i = n = 0; else {
                    var l = o - a;
            ...
            function n(t) {
                ...
                var s, e, i, n = t.h, o = t.s, a = t.l;
                if (0 === o) s = e = i = a; else {
                    var h = .5 > a ? a * (1 + o) : a + o - a * o, l = 2 * a - h;
            ...
            r.exports = {
                hex2rgb: s, rgb2hex: e, rgb2hsl: i, hsl2rgb: n, rgb2rgbString: function (t) {
            ...
            (function (s) {
                ...
                function i(t, r, s, e, i) {
                    var n = parseFloat(t), o = s - r, a = i - e;
                    return (n - r) * a / o + e
                }
                ...
                function v(t, r, s, e, i) {
                    var a = o(i), h = n(i), l = p(e), c = {stroke: S, "stroke-opacity": A, "fill-opacity": a, fill: h};
                ...
                var d = t("extend"), b = t("./color"), m = t("./sha1"), k = t("./svg"), x = {baseColor: "#933c3c"},
                    ...
                    j = "#222", C = "#ddd", S = "#000", A = .02, M = .02, W = .15, H = r.exports = function (t, r) {
                ...
                H.prototype.toSvg = function () {
                    ...
                    var t, r, s, n;
                    this.opts.color ? s = b.hex2rgb(this.opts.color) : (r = i(e(this.hash, 14, 3), 0, 4095, 0, 359), n = e(this.hash, 17), t = b.rgb2hsl(b.hex2rgb(this.opts.baseColor)), t.h = (360 * t.h - r + 360) % 360 / 360, t.s = n % 2 === 0 ? Math.min(1, (100 * t.s + n) / 100) : Math.max(0, (100 * t.s - n) / 100), s = b.hsl2rgb(t)), this.color = b.rgb2hex(s), this.svg.rect(0, 0, "100%", "100%", {fill: b.rgb2rgbString(s)})
                    ...
                    var t, r, s, h, l, c, f, u, p = e(this.hash, 0), g = i(p, 0, 15, 8, 60), v = g * Math.sqrt(3),
                        y = 2 * g, d = a(g);
                    for (this.svg.setWidth(3 * y + 3 * g), this.svg.setHeight(6 * v), s = 0, u = 0; 6 > u; u++) for (f = 0; 6 > f; f++) c = e(this.hash, s), t = f % 2 === 0 ? u * v : u * v + v / 2, h = o(c), r = n(c), l = {
                        fill: r,
                        "fill-opacity": h,
                        stroke: S,
                        "stroke-opacity": A
                    ...
                    var t, r, s, a, l, c, f, u = i(e(this.hash, 0), 0, 15, 30, 80),
                        p = i(e(this.hash, 0), 0, 15, 30, 80), g = h(u, p);
                    for (this.svg.setWidth(6 * u), this.svg.setHeight(6 * p * .66), r = 0, f = 0; 6 > f; f++) for (c = 0; 6 > c; c++) l = e(this.hash, r), s = o(l), t = n(l), a = {
                        stroke: S,
                        "stroke-opacity": A,
                        fill: t,
                        "fill-opacity": s,
                    ...
                    for (this.svg.setWidth(12 * p), this.svg.setHeight(12 * p), s = 0, u = 0; 6 > u; u++) for (f = 0; 6 > f; f++) c = e(this.hash, s), a = o(c), r = n(c), t = u % 2 === 0 ? 0 : 1, h = {
                        fill: r,
                        stroke: S,
                        "stroke-opacity": A,
                        "fill-opacity": a
                    ...
                    for (this.svg.setWidth(3 * v), this.svg.setHeight(3 * v), s = 0, u = 0; 6 > u; u++) for (f = 0; 6 > f; f++) c = e(this.hash, s), a = o(c), t = f % 2 === 0 ? u * v - .5 * v : u * v - .5 * v + v / 4, r = n(c), h = {
                        fill: r,
                        opacity: a
                    ...
                    for (this.svg.setWidth(6 * p), this.svg.setHeight(6 * p), r = 0, c = 0; 6 > c; c++) for (l = 0; 6 > l; l++) h = e(this.hash, r), s = o(h), t = n(h), a = {
                        fill: t,
                        opacity: s
                    ...
                    for (this.svg.setWidth(6 * f), this.svg.setHeight(6 * f), r = 0, l = 0; 6 > l; l++) for (h = 0; 6 > h; h++) a = e(this.hash, r), s = o(a), t = n(a), this.svg.polyline(u, {
                        fill: t,
                        "fill-opacity": s,
                        stroke: S,
                        "stroke-opacity": A
                    ...
                    for (this.svg.setWidth(6 * c), this.svg.setHeight(6 * c), r = 0, l = 0; 6 > l; l++) for (h = 0; 6 > h; h++) a = e(this.hash, r), s = o(a), t = n(a), this.svg.rect(h * c, l * c, c, c, {
                        fill: t,
                        "fill-opacity": s,
                        stroke: S,
                        "stroke-opacity": A
                    ...
                    for (this.svg.setWidth(6 * (f + u)), this.svg.setHeight(6 * (f + u)), r = 0, l = 0; 6 > l; l++) for (h = 0; 6 > h; h++) a = e(this.hash, r), s = o(a), t = n(a), this.svg.circle(h * f + h * u + (f + u) / 2, l * f + l * u + (f + u) / 2, f / 2, {
                        fill: "none",
                        stroke: t,
                        opacity: s,
                        "stroke-width": u + "px"
                    ...
                    for (this.svg.setWidth(6 * u), this.svg.setHeight(6 * u), r = 0, c = 0; 6 > c; c++) for (l = 0; 6 > l; l++) h = e(this.hash, r), s = o(h), t = n(h), a = {
                        fill: "none",
                        stroke: t,
                        opacity: s,
                        "stroke-width": p + "px"
                    ...
                    var t, r, s, a, h, l, c, u, p = e(this.hash, 0), g = i(p, 0, 15, 15, 80), v = g / 2 * Math.sqrt(3),
                        y = f(g, v);
                    for (this.svg.setWidth(3 * g), this.svg.setHeight(6 * v), r = 0, u = 0; 6 > u; u++) for (c = 0; 6 > c; c++) l = e(this.hash, r), s = o(l), t = n(l), h = {
                        fill: t,
                        "fill-opacity": s,
                        stroke: S,
                        "stroke-opacity": A
                    ...
                    var t, r, s, a, h, l, c, f, p = i(e(this.hash, 0), 0, 15, 10, 50),
                        g = i(e(this.hash, 1), 0, 15, 10, 50), v = u(p, g);
                    for (this.svg.setWidth(6 * p), this.svg.setHeight(3 * g), s = 0, f = 0; 6 > f; f++) for (c = 0; 6 > c; c++) l = e(this.hash, s), a = o(l), r = n(l), h = {
                        fill: r,
                        "fill-opacity": a,
                        stroke: S,
                        "stroke-opacity": A
                    ...
                    for (this.svg.setWidth(6 * (u + f) + 6 * f), this.svg.setHeight(6 * (u + f) + 6 * f), r = 0, c = 0; 6 > c; c++) for (l = 0; 6 > l; l++) h = e(this.hash, r), s = o(h), t = n(h), a = {
                        fill: "none",
                        stroke: t,
                        opacity: s,
                        "stroke-width": f + "px"
                    ...
                    for (this.svg.setWidth(8 * n), this.svg.setHeight(8 * n), t = 0, s = 0; 4 > s; s++) for (r = 0; 4 > r; r++) r % 2 === 0 ? s % 2 === 0 ? v(this.svg, r * n * 2, s * n * 2, n, e(this.hash, t)) : g(this.svg, r * n * 2, s * n * 2, n, [e(this.hash, t), e(this.hash, t + 1)]) : s % 2 === 0 ? g(this.svg, r * n * 2, s * n * 2, n, [e(this.hash, t), e(this.hash, t + 1)]) : v(this.svg, r * n * 2, s * n * 2, n, e(this.hash, t)), t += 1
                    ...
                    var t, r, s, a, h, l = i(e(this.hash, 0), 0, 15, 5, 40), c = l * Math.sqrt(3), f = 2 * l,
                        u = l / 2 * Math.sqrt(3), p = y(l, u), g = 3 * l + 2 * u, v = 2 * c + 2 * l;
        ...
        }, {"./color": 2, "./sha1": 5, "./svg": 6, buffer: 8, extend: 9}], 5: [function (t, r) {
            "use strict";
            ...
            function s() {
                ...
                var o = 1732584193, a = 4023233417, h = 2562383102, l = 271733878, c = 3285377520,
                    f = new Uint32Array(80), u = 0, p = 24, g = 0;
            ...
            r.exports = s, s.prototype.currentContext = function () {
                ...
                var o = new i("circle");
                return this.currentContext().appendChild(o), this.setAttributes(o, e({cx: t, cy: r, r: s}, n)), this
            ...
            r.exports = function n() {
                var t, r, e, i, o, a, h = arguments[0] || {}, l = 1, c = arguments.length, f = !1;
                for ("boolean" == typeof h && (f = h, h = arguments[1] || {}, l = 2), "object" != typeof h && "function" != typeof h && (h = {}); c > l; l++) if (null != (t = arguments[l])) for (r in t) e = h[r], i = t[r], h !== i && (f && i && (s(i) || (o = Array.isArray(i))) ? (o ? (o = !1, a = e && Array.isArray(e) ? e : []) : a = e && s(e) ? e : {}, h[r] = n(f, a, i)) : void 0 !== i && (h[r] = i));
                return h
            }
        }, {}]
    }, {}, [1])(1)
    ...
    r.fn.share = function (t) {
        function e(t, e) {
            ...
            "prepend" == e.mode ? n.reverse() : n, n.length && r.each(n, function (n, o) {
                var a = i(o, e), u = e.initialized ? t.find(".icon-" + o) : r('<a class="icon icon-' + o + '"></a>');
